...
const Skills = () => {
  ...
  return (
    <div className="head p-4 pb-12">
      <h2 className="text-center text-black text-[40px] mobile:text-[20px]">
        Skills
      </h2>
          ...
          {skills.map((skill, index) => (
            ...
            >
              <img
                src={skill.src}
                alt={skill.name}
                className=" mobile:w-[70px] mobile:h-[70px] w-[80px] h-[80px] rounded-lg shadow-lg p-[10px] object-contain transition duration-300 border-black border-[2px] ease-in-out hover:bg-gray-500 hover:-translate-y-1"
              />
              {/* Tooltip */}
